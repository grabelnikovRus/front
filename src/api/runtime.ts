...
export const BASE_PATH = 'http://localhost:8030/api-react'.replace(/\/+$/, '')
...
export class BaseAPI {
  ...
  protected async request(context: RequestOpts): Promise<Response> {
    ...
    console.log(`Requesting url: ${url}, method: ${init.method}`);
...
export class JSONApiResponse<T> {
  constructor(
    public raw: Response,
    private readonly transformer: ResponseTransformer<T> = (jsonValue: any) => jsonValue,
  ) {
    this.raw = raw
